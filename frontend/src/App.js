  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 p-4">
      <div className="max-w-7xl mx-auto">
        ...
        {/* Technology Stack */}
        <div className="mt-6 bg-gradient-to-r from-slate-800 to-purple-900 rounded-xl shadow-lg p-6 text-white">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4 text-sm">
            <div>
              <div className="font-semibold text-purple-200 mb-2">🤖 AI Model</div>
              <div className="text-gray-300">Claude Sonnet 4</div>
            </div>
            <div>
              <div className="font-semibold text-purple-200 mb-2">🔒 Security</div>
              <div className="text-gray-300">Multi-layer prompt injection detection</div>
            </div>
            <div>
              <div className="font-semibold text-purple-200 mb-2">🧠 Intelligence</div>
              <div className="text-gray-300">RAG with vector embeddings</div>
            </div>
            <div>
              <div className="font-semibold text-purple-200 mb-2">🚀 Deployment</div>
              <div className="text-gray-300">Vercel (Frontend + Backend API)</div>
            </div>
          </div>
        </div>
      </div>
